...
chapter='class-7/ch12-earth-moon-sun'
history=root/'assets/design-history/science-g7-ch12'
review=root/'build/_class7-ch12-review';review.mkdir(exist_ok=True)
...
print('20 pages rendered; every page in both PDFs has a transparent raster image and live text. Trim and bleed dimensions verified.')

...
chapter='class-7/ch03-electricity-circuits'
history=root/'assets/design-history/science-g7-ch03'
review=root/'build/_class7-ch03-review'
...
for left in range(2,len(files),2):
    sheet=Image.new('RGB',(1300,980),'#d1d5d2');d=ImageDraw.Draw(sheet)
    for j,folio in enumerate([left,left+1]):
...
print(f'PDFs verified: 24 pages each; 8 native transparent image placements; {len(before)} existing files unchanged; Science studio registration confirmed.')

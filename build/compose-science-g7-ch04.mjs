...
function render(meta){
 ...
 if(meta.type==='question'){
  ...
  if(meta.diagram){const d=metalDiagram(meta.diagram);html+=`<g transform="translate(0 ${y})">${d.html}</g>`;y+=d.h+10;const c=caption(meta.caption,y);html+=c.html;y+=c.h+12;}

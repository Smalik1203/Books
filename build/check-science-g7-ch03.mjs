...
assert.equal(files.length,30,'Reviewed extent with an image on every page');
...
assert.ok(mean>=80,'Reviewed mean occupancy with an image on every page and whole panels');

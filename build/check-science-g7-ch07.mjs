...
console.log(`Chapter 7 checks passed: ${files.length} pages, all 5 source activities, 10 questions, 3 projects, ${assets.length} transparent assets. Mean lesson occupancy ${mean.toFixed(1)}%.`);

...
const labels={substances:['lemon','A whole lemon and two cut lemon halves'],circuit:['circuit','Wires, a lamp and a switch in a classroom circuit demonstration'],changes:['ice','A real ice cube on a wet wooden surface'],time:['sundial','Wire shadows on a stainless-steel sundial'],runners:['runners','Three children running, drawn in a warm painted 2D illustration style'],plant:['plant','A sunflower photographed outdoors'],mirrors:['mirrors','Dice and their reflections in a shiny surface']};

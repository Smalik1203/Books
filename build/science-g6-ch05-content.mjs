...
export const projects=[
 ...
 {id:'project3',title:'Investigate older measures',text:'Ask elders which length units they remember using, where they used them and how each was defined. With an adult, look for museum or archaeological information about ruled objects found at Indian sites. Record the source and distinguish measured evidence from an interpretation of what an ancient object was used for. Compare one traditional method with a metric measurement.',figure:'tape',caption:'Different tools and traditions can be compared by stating the unit and method clearly.',source:[22]},
 ...
 {id:'project5',title:'Keep a private height record',text:'Stand safely against a wall while an adult uses a flat book to mark your height. Record the date, unit and method. Repeat about every three months using the same method and similar conditions. Keep your own record private and include a sibling only with permission. Small apparent differences can come from posture or measurement, so check the method before drawing a conclusion.',figure:'opener',caption:'A useful comparison keeps the method consistent across measurements.',source:[22]},

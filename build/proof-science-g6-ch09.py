"""Render all Chapter 9 pages and verify print geometry and embedded images."""
from pathlib import Path
from pypdf import PdfReader
from PIL import Image,ImageDraw
import json,subprocess,hashlib
root=Path(__file__).resolve().parent.parent
chapter='class-6/ch09-methods-of-separation'
history=root/'assets/design-history/science-g6-ch09'
review=root/'build/_class6-ch09-review';review.mkdir(exist_ok=True)

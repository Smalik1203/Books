...
const run=promisify(execFile),chapter=process.argv[2]||'class-6/ch09-methods-of-separation';
const history=process.argv[3]||'assets/design-history/science-g6-ch09';

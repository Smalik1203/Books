...
for(let i=0;i<pages.length;i++){
 ...
 scienceContract('Chapter 11 '+n,html);await fs.writeFile(`${dir}/p${String(n).padStart(3,'0')}.html`,html);
...
await fs.writeFile(history+'/editorial-ledger.json',JSON.stringify({opener:{source:[1],paragraphs:opener},lesson,glossary:{purpose:'Reference definitions for terms taught in the chapter',entries:glossary},summary,games,assessment:{purpose:'All sixteen source questions retained with safety and evidence qualifications',questions:exercises},projects},null,2));

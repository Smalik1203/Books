...
const run=promisify(execFile),chapter=process.argv[2]||'class-6/ch06-materials-around-us';
const history=process.argv[3]||'assets/design-history/science-g6-ch06';

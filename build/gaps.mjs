...
const VERDICT = {
  ...
  'c-example': 'an example — a panel; never divided, close the gap in prose',
  'c-reflect': 'a reflect box — a panel; never divided, close the gap in prose',
  'c-keyidea': 'a key idea — a panel; never divided, close the gap in prose',
  'c-tip': 'a tip — a panel; never divided, close the gap in prose',
  'c-solution': 'a solution — a panel; never divided, close the gap in prose',
  'c-problem': 'a problem — a panel; never divided, close the gap in prose',
  'c-try': 'a question — a panel; never divided, close the gap in prose',
  'c-stage': 'a stage head — it may not be stranded at the foot',
  'c-bridge': 'the division opener — it starts a page of its own',

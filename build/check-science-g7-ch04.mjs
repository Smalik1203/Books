...
const assets=JSON.parse(await fs.readFile(history+'/artwork.json','utf8'));assert.equal(assets.length,9);
...
console.log(`Chapter 4 checks passed: ${files.length} pages, all 8 source activities, 12 questions, 4 projects, 9 transparent assets. Mean lesson occupancy ${mean.toFixed(1)}%.`);

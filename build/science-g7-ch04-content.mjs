...
export const lesson=[
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "4. Compare what you observed with what the teacher showed using sulfur dioxide. Explain why the two starting substances must not be treated as the same material."
    ]
  },
  {

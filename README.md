...
| **page box, − / level / + / fit** | Chrome's PDF toolbar, in Chrome's order. The level opens the presets; the fit button shows the mode it is in — an upright sheet for fit to page, a wide one for fit to width — and returns to fit to page from any fixed percentage |

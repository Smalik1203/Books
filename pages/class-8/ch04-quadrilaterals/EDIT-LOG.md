...
word against the pre-edit snapshot in `build/_jee-backups/class-8/ch05-quadrilaterals/`.
...
|---:|---|---|
| 1 | Single correct | (c) 11 |
| 2 | Single correct | (a) $160^\circ$ |
| 3 | Single correct | (b) 30 |
| 4 | Single correct | (d) $110^\circ$ |
| 5 | Single correct | (a) 24 |
| 6 | Single correct | (b) $35^\circ$ |
| 7 | Multiple correct | (a), (c) |
| 8 | Multiple correct | (a), (b), (d) |
| 9 | Multiple correct | (a), (b), (c) |
| 10 | Multiple correct | (a), (c), (d) |
| 11 | Numerical answer | 13 |
| 12 | Numerical answer | 128 |
| 13 | Numerical answer | 18 |
...
The chapter now carries NCERT's own title, *Quadrilaterals*, taken from the chapter's first page in the NCERT textbook, in place of the house title it had. Changed in `chapter.json` and the opener heading in `p001.html`; nothing else in the chapter uses the title.

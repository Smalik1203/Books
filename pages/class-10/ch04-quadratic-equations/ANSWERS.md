...
1. (a) $3$ and $\frac{1}{2}$ *(single correct)*
2. (b) $-8$ *(single correct)*
3. (c) 9 *(single correct)*
4. (d) two distinct irrational roots *(single correct)*
5. (a) 17 *(single correct)*
6. (b) $3$ and $-4$ *(single correct)*
...
13. 40 *(numerical answer)*
14. (c) P–3, Q–4, R–1, S–2 *(matching)*
15. (b) P–4, Q–3, R–1, S–2 *(matching)*

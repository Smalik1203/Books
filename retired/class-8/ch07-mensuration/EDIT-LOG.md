...
word against the pre-edit snapshot in `build/_jee-backups/class-8/ch07-mensuration/`.
...
|---:|---|---|
| 1 | Single correct | (c) 18 cm |
| 2 | Single correct | (b) 32 cm |
| 3 | Single correct | (a) $450 \text{ m}^2$ |
| 4 | Single correct | (d) $220 \text{ m}^2$ |
| 5 | Single correct | (a) 7 cm |
| 6 | Single correct | (c) $\frac{1}{8}$ |
| 7 | Multiple correct | (a), (b), (c) |
| 8 | Multiple correct | (a), (b) |
| 9 | Multiple correct | (a), (b), (c), (d) |
| 10 | Multiple correct | (a), (b), (d) |
| 11 | Numerical answer | 60 |
| 12 | Numerical answer | 1540 |
| 13 | Numerical answer | 11.5 |
| 14 | Matching | (c) P–4, Q–1, R–3, S–2 |
| 15 | Matching | (b) P–3, Q–1, R–4, S–2 |
